import { MousePointer2, Crop, Square, PenTool, Type, StickyNote } from 'lucide-react';
  ...
  return (
    <div className="bg-[#2c2c2c] px-2 py-1.5 flex items-center justify-between border-b border-[#1e1e1e]">
      <div className="flex items-center gap-0.5">
        ...
        <button className="p-2 hover:bg-[#383838] rounded transition-colors" title="Crop">
        ...
        <button className="p-2 hover:bg-[#383838] rounded transition-colors" title="Notes">
