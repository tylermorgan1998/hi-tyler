import { ChevronDown, Type, Square, Search, Plus, FileText, Frame, Layers2, RectangleHorizontal } from 'lucide-react';
  ...
  return (
    <div className="w-56 bg-[#2c2c2c] border-r border-[#1e1e1e] flex flex-col h-full">
      ...
      <div className="px-3 py-2 border-b border-[#1e1e1e] flex items-center justify-between">
        <span className="text-[#666] text-xs">Layers</span>
        <button className="text-[#666] hover:text-[#b3b3b3] transition-colors">
          <Plus size={14} />
        </button>
      </div>
      ...
      <div className="px-3 py-2 border-b border-[#1e1e1e]">
        <div className="bg-[#1e1e1e] rounded px-2 py-1.5 flex items-center gap-2">
          ...
          <input
            ...
            className="bg-transparent text-[#666] text-xs outline-none flex-1 placeholder:text-[#666]"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-2">
        <div className="space-y-0.5">
          ...
          <div className="flex items-center gap-1 py-1 px-2 hover:bg-[#383838] rounded cursor-pointer">
            ...
            <span className="text-[#666] text-xs flex-1">Page 1</span>
          </div>
          ...
          <div className="ml-3">
            <div className="flex items-center gap-1 py-1 px-2 hover:bg-[#383838] rounded cursor-pointer">
              <ChevronDown size={10} className="text-[#666]" />
              <Frame size={12} className="text-[#666]" />
              <span className="text-[#666] text-xs flex-1">Frame 1</span>
            </div>
            ...
            <div className="ml-3">
              <div className="flex items-center gap-1 py-1 px-2 hover:bg-[#383838] rounded cursor-pointer">
                <ChevronDown size={10} className="text-[#666]" />
                <Layers2 size={12} className="text-[#666]" />
            ...
            <div className="ml-3">
              <div className="flex items-center gap-1 py-1 px-2 hover:bg-[#383838] rounded cursor-pointer">
                <div className="w-3" />
                <Square size={12} className="text-[#666]" />
                <span className="text-[#666] text-xs flex-1">Background</span>
              </div>
            </div>
          </div>
        </div>
